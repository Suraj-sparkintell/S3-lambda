# S3-lambda
This function will upload a binary image file sent from a POST request from API Gateway with a proxy Lambda function integration. It will decode the binary string file, create an image file in the /tmp directory and call S3 to upload the object.
